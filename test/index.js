...
describe('driver structure', () => {
	...
	describe('capability methods', () => {
		//add/remove tests for each capability of your device
		
		it('should have an \'capability_on\' method that promises to get the current track from the specified sonos speaker', () => {
			var driverSettings = new class DriverSettings {
				get() {
					return Promise.resolve({});
				}
		...
		it('should have an \'capability_off\' method that promises to flush the queue of the speaker', () => {
			var driverSettings = new class DriverSettings {
				get() {
					return Promise.resolve({});
				}
